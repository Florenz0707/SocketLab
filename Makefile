...
# all objects
OBJ := $(OBJ_DIR)/y.tab.o $(OBJ_DIR)/lex.yy.o $(OBJ_DIR)/parse.o $(OBJ_DIR)/example.o $(OBJ_DIR)/utils.o
# all binaries
...
liso_server: $(OBJ_DIR)/liso_server.o $(OBJ_DIR)/parse.o $(OBJ_DIR)/utils.o $(OBJ_DIR)/y.tab.o $(OBJ_DIR)/lex.yy.o
	$(CC) -Werror $^ -o $@
